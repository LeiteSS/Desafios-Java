...
public class Note extends javax.swing.JFrame {
     ...
     */
    public Note(PostItNotes manager,String body) {        
        initComponents(); // this should be first ... Caution DO NOT MOVE
